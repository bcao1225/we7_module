 ...
 */
//$mchid = '1484152192';          //微信支付商户号 PartnerID 通过微信支付商户资料审核后邮件发送
//$appid = 'wx2a09a825296b174c';  //微信支付申请对应的公众号的APPID
//$appKey = '17dbf8d04970ef94399ad55ff218b316';   //微信支付申请对应的公众号的APP Key
//$apiKey = 'monaiwangluo12345678monaiwangluo';   //https://pay.weixin.qq.com 帐户设置-安全设置-API安全-API密钥-设置API密钥
...
class Wxpay
{
	...
	public function createJsBizPackage($openid, $totalFee, $outTradeNo, $apiclient_cert, $apiclient_key, $money_desc)
	{
		...
		$unified = array(
			...
			're_user_name' => '',                 //收款用户真实姓名（不支持给非实名用户打款）
