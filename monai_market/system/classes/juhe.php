...
class juhe{
    ...
    private $carPre = 'http://v.juhe.cn/wz/carPre';
    ...
    */
     ...
     * @return array
     */
    public function getCity_one($province){
        $params = 'key='.$this->appkey."&hphm=".$province;
        $content = $this->juhecurl($this->carPre,$params);
        return $this->_returnArray($content);
    }
